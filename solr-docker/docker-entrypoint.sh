...
/opt/docker-solr/scripts/precreate-core dea /opt/solr/server/solr/configsets/mycore_main
/opt/docker-solr/scripts/precreate-core dea-classifications /opt/solr/server/solr/configsets/mycore_classification
